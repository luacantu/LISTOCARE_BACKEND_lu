...
#     doctor_id = db.Column(db.Integer, db.ForeignKey('specialty'),
#         nullable=True)
#     def __repr__(self):
...
class Treatment(db.Model):
    ...
    room_number = db.Column(db.String(120), unique=True, nullable=False)
    email = db.Column(db.String(120), unique=True, nullable=False)
...
class Diagnostic(db.Model):
    ...
    reasonforadmi = db.Column(db.String(120))
